 ...
 */
package com.onejava.hjshell.template.tables.cell.base;
...
public abstract class FunctionWithCharAndWidth
{
     ...
     */
    public static FunctionWithCharAndWidth from(final com.onejava.hjshell.template.tables.line.base.FunctionWithCharAndWidth f) {
