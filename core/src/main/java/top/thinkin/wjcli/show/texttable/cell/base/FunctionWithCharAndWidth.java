 ...
 */
package top.thinkin.wjcli.show.texttable.cell.base;
...
public abstract class FunctionWithCharAndWidth
{
     ...
     */
    public static FunctionWithCharAndWidth from(final top.thinkin.wjcli.show.texttable.line.base.FunctionWithCharAndWidth f) {
